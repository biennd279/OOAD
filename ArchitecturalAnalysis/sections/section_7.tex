...
\begin{document}
	...
	\begin{figure}[htb]
		\centering
		\resizebox{0.6\textwidth}{!}{\input{./images/subpackageindomain.pdf_tex}}
	...
	\begin{figure}[H]
		\centering
		\resizebox{1.0\textwidth}{!}{\input{./images/PackageUser_LogicalView.pdf_tex}}
		\caption{Biểu đồ gói con trong miền}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\resizebox{1.0\textwidth}{!}{\input{./images/PackageSocial_LogicalView.pdf_tex}}
		\caption{Biểu đồ gói con trong miền}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\resizebox{1.0\textwidth}{!}{\input{./images/PresentationPackage.pdf_tex}}
	...
	\begin{figure}[H]
		\centering
		\resizebox{1.0\textwidth}{!}{\input{./images/application_package.pdf_tex}}
		\caption{Biểu đồ gói gói giao diện}
	\end{figure}
	...
	\paragraph{Biểu đồ}~\\
		\begin{figure}[H]
		\centering
		\resizebox{0.8\textwidth}{!}{\input{./images/logic_view_persistence_package.pdf_tex}}
