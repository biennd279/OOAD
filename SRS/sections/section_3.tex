...
\subsubsection{Mô tả tóm tắt}
Danh sách các lớp học phần được quản trị viên tạo ra từ các dữ liệu của trường. Quản trị viên có thể kiểm soát, thêm mới, sửa đổi hoặc xóa các lớp học của học kỳ.
...
\begin{table}[H]
		...
		7. Quản trị viên chọn thêm mới lớp học phần học     & 8. Hệ thống hiển thị trang điền thông tin lớp học phần &                  \\ \hline
		9. Quản trị viên điền thông tin lớp học phần &
		10. Hệ thống thông báo xác nhận và thêm mới lớp học phần. &
		\begin{tabular}[c]{@{}l@{}}Thông tin về lớp học phần:\\ Mã lớp \\ Tên lớp\\ Mã giảng viên\\ Tên giảng viên\\ Số tín  chỉ\end{tabular} \\ \hline
	\end{tabular}
\end{table}
\paragraph{Luồng thay thế}
\begin{itemize}
