...
\begin{longtable}{|p{.33\textwidth}|p{.33\textwidth}|p{.33\textwidth}|}
		...
		5. Giảng viên tạo bộ lọc để hiển thị danh sách theo ý muốn             & 6. Hệ thống hiển thị danh sách người tham gia theo bộ lọc &                  \\ \hline
		7. Giảng viên thêm người tham gia & 8. Hệ thống kiểm tra và ghi nhận thay đổi của người dùng              &                  \\ \hline
\end{longtable}
\paragraph{Luồng thay thế}
\begin{itemize}
...
\begin{longtable}{|p{.33\textwidth}|p{.33\textwidth}|p{.33\textwidth}|}
		\hline
		\textbf{Hành động}              & \textbf{Hệ thống phản hồi}                 & \textbf{Dữ liệu} \\ \hline
		1. Giảng viên yêu cầu danh sách khóa học của mình & 2. Hệ thống hiển thị danh sách khóa học trong học kỳ & Danh sách khóa học của giảng viên \\ \hline 
		3. Giảng viên truy cập vào khóa học & 4. Hệ thống hiển thị giao diện khóa học &  Nội dung khóa học              \\ \hline
		5. Giảng viên yêu cầu tạo lớp học trực tuyến                 & 4. Hệ thống khởi tạo khóa học trực tuyến và thông báo cho thành viên lớp. &  Thời gian tạo, người tham gia, người tạo,... \\ \hline
...
\begin{longtable}{|p{.33\textwidth}|p{.33\textwidth}|p{.33\textwidth}|}
 		...
 		3. Quản trị viên yêu cầu cấp mới tài khoản                          & 4. Hệ thống hiển thị trang đăng ký thêm mới tài khoản &                     \\ \hline
 		...
 		7. Quản trị viên yêu cầu xuất dữ liệu danh sach             & 8. Hệ thống trả về file trích xuất dữ liệu            & File trích xuất     \\ \hline
\end{longtable}
\paragraph{Luồng thay thế}
\begin{itemize}
