...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{ucr_ss_manage_student_activity.eps}
    \caption{Biểu đồ tuần tự - Luồng giảng viên chấp nhận yêu cầu tham gia khóa học của sinh viên (tích hợp hệ thống con)}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{ucd_ss_manage_student_activity.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{ucd_ss_manage_forum.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{ucr_per_manage_contentcourse.eps}
    \caption{Biểu đồ tuần tự - Quản lý nội dung khóa học (tích hợp Persistence)}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{ucd_per_manage_contentcourse.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{ucr_per_add_course_mem.eps}
    \caption{Biểu đồ tuần tự - Quản lý danh sách sinh viên (tích hợp Persistence)}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{ucd_per_add_course_mem.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{ucr_per_create_live_lesson.eps}
    \caption{Biểu đồ tuần tự - Quản lý dạy học trực tuyến (tích hợp tất cả)}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{ucd_per_create_live_lesson.eps}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{ucr_ss_account_manage.eps}
    \caption{Biểu đồ tuần tự - Quản lý tài khoản (tích hợp tất cả)}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{ucd_ss_account_manage.eps}
